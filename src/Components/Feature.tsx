...
<div className='relative overflow-hidden container m-auto'>
      ...
      <div className='space-y-12 '>
          ...
          <p className='text-[16px] sm:text-xl'style={{fontFamily:'Proxima-Nova-Regular, sans-serif',lineHeight:'42px', letterSpacing:'2%'}}>Cras at pellentesque eros. Nullam vitae <br />sapien et felis eleifend luctus. Nam ac dui</p>
          <div className="">
      ...
      <div className=' flex flex-col md:flex-row justify-between text-white '>
          <Image src="/main.svg" alt="main" width={400} height={310} className='w-full h-[40rem] sm:h-[100%]'  />
      </div>
  </div>
  </div>
    </div>
