...
const YouTube = () => {
  ...
  <div className='w-100 h-auto bg-[#E6F2F7] 3xl:pl-[8%]'>
 <div className='relative overflow-hidden container m-auto sm:px-6 px-6 w-100' >
    ...
    <div className='py-10 sm:py-20  sm:px-14'>
        ...
        <p className='sm:text-[28px]  pt-9 text-[#101828E5] sm:leading-[42px] ' style={{fontFamily: 'Proxima-Nova-Regular, sans-serif'}}>Your search for a great relationship has never been easier with <br /> groundbreaking overhaul of the eharmony you know and trust.
        </p>
        ...
        <Image src="/YT.svg" width={1224} height={500} alt='yt' className='relative  sm:left-2 z-0 mt-8 sm:h-[20%] 3xl:w-[90%]'/>
    </div>
