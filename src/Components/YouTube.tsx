...
const YouTube = () => {
  ...
  <div className='w-100 h-auto bg-[#E6F2F7] 3xl:pl-[8%] xl:px-8'>
 <div className='relative overflow-hidden container m-auto sm:px-6 px-6 w-100' >
    ...
    <div className='py-10 sm:py-20  sm:px-14 '>
        ...
        <Image src="/YT.svg" width={1224} height={500} alt='yt' className='relative  sm:left-2 z-0 mt-8 sm:h-[20%] 3xl:w-[90%] 5xl:w-[100%]'/>
