...
const YouTube = () => {
 ...
 <div className='relative overflow-hidden container m-auto sm:px-6 px-6 w-100' >
    ...
    <div className='py-20  sm:px-14'>
        ...
        <p className='sm:text-[28px]  pt-9 text-[#101828E5]' style={{fontFamily: 'Proxima-Nova-Regular, sans-serif', lineHeight: '42px'}}>Your search for a great relationship has never been easier with <br /> groundbreaking overhaul of the eharmony you know and trust.
        </p>
